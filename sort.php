...
//checking if the user is logged in and yes has not logged out
if (isset($_SESSION['login_username']))
{
    //fetching the email id of user who is online
    $user = $_SESSION['login_username'];
    
    //fetchin all the detail of the user logged in
    ...
    //fetching the metdod(Asc/Desc) to sort data
    $sort = $_POST['SortBy'];
    
} 
//if the user has log out then ask them to login first
else
{
    echo 'please Login first to Go to the main Page.';
    //if logout then dont display the page. exit from here.
    die();
}
?>
        ...
        <div id="main">
                ...
                <fieldset>
                    ...
                    <form name="changeLib" method="POST" action="changeLib.php">
                        <select name="ChangeActiveLibrary">
                            ...
                            <?php
                            //display all the library of the user
            ...
            <div id="rightForm">
                <div id="Table">
                    ...
                    <?php
                    $query1 = "SELECT * FROM ReferenceLibrary where Email='$user' ORDER BY Title $sort";
                    echo " <table border='1' bordercolor='#c86260' bgcolor='#ffffcc' width='120%' cellspacing='2' cellpadding='5'>
                               <tr>
                            <th>All</th>
                            <th>Id</th>
                            <th>Author</th>
