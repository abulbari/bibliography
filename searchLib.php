...
<!--                        <input type="submit" value="Move Selected"></input>-->
                    ...
                    <?php
                    $query1 = "SELECT * FROM ReferenceLibrary where Title LIKE '%$title%' and Email='$user' and Author LIKE '%$author%'";
                ...
                <div id="detail">
                    ...
                    <form name="addDetails" method="POST" action="addToLib.php">
                        <div id="button">
                            <input type="submit" value="AddNew"></input>
