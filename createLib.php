...
{
    //fetch all the data of user in case we need it in this page
    ...
    //fetch the name of library you want to create
    $libraryname = $_POST['addLib'];
    
    //insert the library created into the library table
    $sql = "INSERT INTO Library(Email,LibName) VALUES('$user','$libraryname')";
    ...
    {
        echo "<script>alert('New Library Created. Check It In Your Library Table/Option');</script>\n";
    }
    
} 
//is user is not online
else
{
